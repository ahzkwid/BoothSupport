...
このリンクからUnityHubをダウンロードして実行する

## Unity2022.3.22f1のインストール

<img width="436" height="398" alt="image" src="https://github.com/user-attachments/assets/7c96aeb9-32fe-4feb-935d-7eb484210a1d" />

[Unity 2022.3.22f1のインストール](unityhub://2022.3.22f1/887be4894c44)

インストール後、これを押すと2022.3.22f1がインストールされる
...
<img width="811" height="641" alt="image" src="https://github.com/user-attachments/assets/1f83519a-fe51-44c5-bcda-19d7060cab90" />

<img width="367" height="239" alt="image" src="https://github.com/user-attachments/assets/37f0a22f-d1af-4eba-aecc-f03f4601f6b7" />

## VCCとUnityのコネクション

<img width="956" height="592" alt="image" src="https://github.com/user-attachments/assets/a9ff53f3-6176-4bdb-88e9-f6373d986fb9" />
...
そのキャラクターのトゥーンシェーダーパッケージもアップロードする必要がある

通常はliltoonを使う

<img width="407" height="207" alt="image" src="https://github.com/user-attachments/assets/716e95c9-2d1f-43b0-96b6-8a48bd267ed6" />

この画面が出たら Install を押す。


<img width="961" height="802" alt="image" src="https://github.com/user-attachments/assets/32793e21-3b9e-4b9c-b088-0d13712ad7f1" />

服とキャラクターをシーンにドラッグして配置する

なるべくkisekae版をおすすめ

なければキャラクターを上げてから服を消す
...
Show Control Panel を押してログイン。

Builder で名前とサムネイルを設定する。
