...
データを利用せずに、自分の力で作りなさい👊（シフォン版の衣装をトレースして再販するクズが見つかりました。）

데이터 갖다 쓰지 말고 자신의 힘으로 직접 만들어라
...
ただし、ユーザーが衣装を販売できるゲームはプラットフォームとみなします。
  例: VRC、Roblox、マイクラ、ZEPETOなどは禁止。LOL、Overwatchはプラットフォームではないため可能
### この決定に至った理由は?
過去にサブカルチャー系ゲームを制作しようとしましたが、衣装不足の問題により中断した経緯があります。
そのため、ゲーム制作目的に限り、特別に許可しています。
